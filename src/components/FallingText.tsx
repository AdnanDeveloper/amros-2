...
const FallingTextEffect: React.FC<FallingTextProps> = ({
    text = '',
    highlightWords = [],
    ...
    useEffect(() => {
        ...
        // Allow page scroll to pass through — override Matter.js wheel handler
        (mouse as any).mousewheel = () => { /* no-op: let wheel events propagate */ };

        // Make the physics canvas non-interactive so events reach the page
